...
public class AdapterRecommend extends RecyclerView.Adapter implements OnBannerListener{
    ...
    public AdapterRecommend(Context context, List<String> images, List<String> titles,
    ...
    private void loadholder2(RecyclerView.ViewHolder holder) {
        ...
        ((ViewHolder2) holder).recyclerView
                .setAdapter(new AdapterZhihuContent(mcontext, zhihuData));
    ...
    private void loadholder3(RecyclerView.ViewHolder holder) {
        ...
        ((ViewHolder3) holder).imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), ActivityWelfare.class);
    ...
    private void loadholder4(RecyclerView.ViewHolder holder) {
        ...
        ((ViewHolder4) holder).recyclerView
                .setAdapter(new AdapterGankContent(gankData));
    ...
    private void loadholder5(RecyclerView.ViewHolder holder) {
        ...
        ((ViewHolder5) holder).recyclerView
                .setLayoutManager(new LinearLayoutManager(mcontext));
        ((ViewHolder5) holder).recyclerView
                .setAdapter(new AdapterJokeContent(mcontext, jokeData));
    ...
    public void OnBannerClick(int position) {
        ...
        Intent intent = new Intent(mcontext, ActivityZhihu.class);
