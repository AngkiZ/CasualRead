...
import com.angki.casualread.mvp.ui.activity.ActivityWelfare;
...
public class AdapterWelfareFragmentRecycleView extends
        RecyclerView.Adapter<AdapterWelfareFragmentRecycleView.ViewHoler>{
    ...
    public AdapterWelfareFragmentRecycleView(Context context, List<dbWelfare> dataList) {
    ...
    @Override
    public AdapterWelfareFragmentRecycleView.ViewHoler onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        holer.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(parent.getContext(), ActivityWelfare.class);
    ...
    @Override
    public void onBindViewHolder(AdapterWelfareFragmentRecycleView.ViewHoler holder, int position) {
