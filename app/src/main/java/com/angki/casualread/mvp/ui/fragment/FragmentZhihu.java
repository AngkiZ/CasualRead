...
public class FragmentZhihu extends Fragment{
    ...
    private AdapterZhihuFragmentRecycleView adapter;
    ...
    public static FragmentZhihu newInstance() {
        return new FragmentZhihu();
    }
    @Override
    ...
    private void loadModule(View view) {
        ...
        //加载adpter适配器
        adapter = new AdapterZhihuFragmentRecycleView(getContext(), dataList, 1);
