...
import com.angki.casualread.mvp.ui.fragment.FragemntHome;
...
public class ActivityMain extends AppCompatActivity {
    ...
    //主碎片
    private FragemntHome fragemntHome;
    //收藏碎片
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            fragemntHome = (FragemntHome) getSupportFragmentManager().getFragment(savedInstanceState, "HomeFragment");
            fragmentCollection = (FragmentCollection) getSupportFragmentManager().getFragment(savedInstanceState, "CollcetionFragment");
        } else {
            fragemntHome = new FragemntHome();
    ...
    private void loadMoudle() {
        ...
        if (fragemntHome != null) {
            replaceFragment(fragemntHome);
        }else {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case drawer_layout_collect:
                        ...
                        actionBar.setTitle("收藏");
                        replaceFragment(fragmentCollection);
                        break;
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        //判断homeFragemnt是否被添加
        if (fragemntHome.isAdded()) {
            getSupportFragmentManager().putFragment(outState, "HomeFragment", fragemntHome);
        }
        //判断collectionFragment是否被添加，且判断collectionFragment是否为空
        if (fragmentCollection != null && fragmentCollection.isAdded()) {
            getSupportFragmentManager().putFragment(outState, "CollcetionFragment", fragmentCollection);
        }
    }
