...
public class AdapterZhihuFragmentRecycleView extends RecyclerView.Adapter<AdapterZhihuFragmentRecycleView.ViewHolder>{
    ...
    public AdapterZhihuFragmentRecycleView
